...
Begin VB.Form tagreissue 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Combo1 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "tagreissue.frx":0000
         Left            =   2280
         List            =   "tagreissue.frx":000A
...
b = MsgBox("Sure? Re Issue Tag ? ", vbOKCancel, "Print ?")
If b = vbCancel Then
...
+ "','" + Trim(Text4.Text) + "','" + Trim(Text10.Text) + "','" + "" + "','" + "TAG REISSUE" + "','" _
...
rs1.MoveFirst
    If rs1.Fields("valid") = 0 Then
        status.Caption = "CAN BE RE-ISSUED"
        Command3.Visible = False
        Command1.Visible = True
    ElseIf rs1.Fields("valid") = 1 Then
        status.Caption = "ACTIVE TAG, CAN BE MODIFIED"
        Command1.Visible = False
        Command3.Visible = True
    Else
        status.Caption = "SECOND WEIGHT DUE, CAN NOT BE MODIFIED"
        Command1.Visible = False
        Command3.Visible = False
    End If
    
    Text1.Text = rs1.Fields("tagno")
...
b = MsgBox("Sure? Modify Tag ? ", vbOKCancel, "Print ?")
If b = vbCancel Then
    MsgBox "Saving Cancelled"
    Exit Sub
End If
...
On Error GoTo errmess
costr = "update tags set tagtrips = " + Trim(Text2.Text) + ", expiry = '" _
+ Format(Year(DTPicker2.Value), "00##") + Format(Month(DTPicker2.Value), "0#") + Format(Day(DTPicker2.Value), "0#") _
+ "', tc_code = '" + Trim(Text4.Text) + "', tm_CODE = '" + Trim(Text7.Text) + "', rlw = " + Trim(Text13.Text) _
+ ", do_no = '" + Trim(Text11.Text) + "', coll_code = '" + Trim(Text17.Text) + "', driver = '" _
+ Trim(Text25.Text) + "', driver_address = '" + Trim(Text26.Text) + "', driver_phone = '" + Trim(Text27.Text) _
+ "', photo = '" + Trim(Text28.Text) + "', unit = '" + Trim(Text3.Text) + "', mode = '" + Trim(wmode) + "', wmode = '" + Trim(wtype) _
+ "' where (v_no = '" + _
Trim(Text4.Text) + "' or tagno = '" + Trim(Text1.Text) + "') and valid='1'"
co1.Execute costr

co1.Execute "insert into tagexceptions (edate,etime,tagno,v_no,ccode,sl_no,type,description,o_name,area,wb)" _
+ " values ('" + Format(DTPicker2.Value, "yyyy/mm/dd") + "','" + Trim(Texttime.Text) + "','" + Trim(Text1.Text) _
+ "','" + Trim(Text4.Text) + "','" + Trim(Text10.Text) + "','" + "" + "','" + "TAG MODIFY" + "','" _
+ Trim(Text9.Text) + "','" + loginname + "','" + Left(Text3.Text, 2) + "','" + Right(Text3.Text, 2) + "' );"

MsgBox "Tag information modified"
b = 1
    While b = 1
    b = MsgBox("Print Tag ", vbOKCancel, "Print ?")
    If b = 1 Then
