...
rs3.Open "delete * from allotment where do_no='" + Trim(Text1.Text) + "' and w_date>=#" & Format(DTPicker1.Value, "mm/dd/yyyy") & "# and w_date<=#" & Format(DTPicker2.Value, "mm/dd/yyyy") & "#", co, adOpenKeyset, adLockOptimistic
...
showtext
Else
MsgBox "Incorrect date range..only 45 days allotment allowed"
dataok = False
End If
End Sub
...
If DTPicker1.Value >= dtpstart.Value And DTPicker1.Value <= dtpend.Value Then
...
hidetext
dataok = False
MsgBox "Invalid start date..out of do range"
DTPicker1.Value = dtpstart.Value
End If
End Sub
...
Sub showtext()
    ...
    For i = 0 To m
        ...
        rs1.Open "select * from allotment where do_no='" + Trim(Text1.Text) + "' and w_date=#" & Format(DTPicker3.Value, "mm/dd/yyyy") & "#", co, adOpenKeyset, adLockOptimistic
...
If DTPicker2.Value >= dtpstart.Value And DTPicker2.Value <= dtpend.Value Then
...
hidetext
dataok = False
MsgBox "Invalid end date..out of do range"
End If
End Sub
...
If Trim(Text1.Text) <> "" And KeyAscii = 13 Then
    ...
    If rs3.RecordCount > 0 Then
        ...
        dtpstart.Value = DTPicker1.Value
        tmpdt.Value = CDate(Format("01/01/2000", "dd/mm/yyyy"))
