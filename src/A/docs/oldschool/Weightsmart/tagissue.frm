...
Begin VB.Form tagissue 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox Combo1 
         ...
         EndProperty
         Height          =   360
         ItemData        =   "tagissue.frx":0000
         Left            =   2280
         List            =   "tagissue.frx":000A
...
b = MsgBox("Sure? Save Tag ? ", vbOKCancel, "Print ?")
If b = vbCancel Then
...
rs1.Open "Select * from  tags where (v_no = '" + Trim(Text4.Text) + "' or tagno = '" + Trim(Text1.Text) + "') and valid!='0'", co1, adOpenKeyset, adLockOptimistic
...
'rs1.AddNew
'rs1.Fields("tagno").Value = "'" + Trim(Text1.Text) + "'"
'rs1.Fields("tagtype").Value = "'" + Trim(Combo1.Text) + "'"
'rs1.Fields("issue").Value = "#" + Format(DTPicker1.Value, "mm/dd/yyyy") + "#"
'rs1.Fields("expiry").Value = "#" + Format(DTPicker2.Value, "mm/dd/yyyy") + "#"
...
MsgBox "Tag information saved"
    ...
    Wend
Else
MsgBox "Tag No. still active or Vehicle has another active Tag"
End If
rs1.Close
Exit Sub
...
If Val(Trim(Text13.Text)) < 15000 Then
MsgBox "RLW cannot be less than 15 Ton", vbInformation, "Data Error"
Text13.SetFocus
Exit Sub
End If
