...
rs5.Open "delete  from  mater where m_code='" & Trim(Text1.Text) & "'", co, adOpenKeyset, adLockOptimistic
...
rs1.AddNew
End If
 rs1.Fields("m_CODE").Value = Text1.Text
 rs1.Fields("m_name").Value = Text2.Text
' rs1.Fields("grade").Value = Text3.Text
' rs1.Fields("csize").Value = Text4.Text
' rs1.Fields("flame").Value = Text5.Text
 rs1.Update
...
rs1.Open "Select * from mater where m_code='" & Trim(Text1.Text) & "'", co, adOpenKeyset, adLockOptimistic
...
Set rs1 = New ADODB.Recordset
rs1.Open "Select * from mater  order by val(m_code)", co, adOpenKeyset, adLockOptimistic
If rs1.RecordCount > 0 Then
rs1.MoveLast
...
While Not rs.EOF
List1.AddItem Trim(rs.Fields("m_name").Value) & " (" & Trim(rs.Fields("m_code").Value) & ")"
...
While Not rs.EOF
List1.AddItem padl(rs.Fields("m_code").Value, 5) & " " & padl(rs.Fields("m_name").Value, 25)
...
opedit = True
recfound = True
Text2.Text = rs1.Fields("m_name").Value
'Text3.Text = rs1.Fields("grade").Value
'Text4.Text = rs1.Fields("csize").Value
'Text5.Text = rs1.Fields("flame").Value
End If
End Sub
