...
Begin VB.Form dmaterrep 
   ...
   Begin VB.Label Label8 
      ...
      Caption         =   " Material Wise Report(Special)"
      BeginProperty Font 
         Name            =   "Arial"
         Size            =   12
         Charset         =   0
...
If Trim(Text1.Text) <> "" Then
    SQL = SQL & " and tm_code = '" & Trim(Text1.Text) & "' order by sl_no desc"
Else
    SQL = SQL & " order by tm_code, sl_no desc"
End If
...
wstream.WriteLine Chr(27) & "E" & Chr(14) & PADC("Material Wise Report Sorted", 28) & Chr(27) & "F"
Else
wstream.WriteLine Chr(27) & "E" & Chr(14) & PADC("Selected Material Report", 28) & Chr(27) & "F"
End If
wstream.WriteBlankLines 1
wstream.WriteLine Chr(27) & "E" & Chr(15) & "From Date: " & CStr(DTPicker1.Value) & "      To Date: " & CStr(DTPicker2.Value) & Chr(27) & "F"
wstream.WriteLine Chr(27) & "E" & Chr(15) & "Material: " & Text1.Text & Chr(27) & "F"
...
If Grid1.Text <> matercod Then
    wstream.WriteLine Chr(18) & String(80, "-")
    wstream.WriteLine Chr(18) & Chr(15) & Chr(14) & "Material: " & matercod & "    Total: " & CStr(matertot)
    wstream.WriteLine Chr(18) & String(80, "-")
    matertot = 0
    materbr = False
End If
...
If Option1.Value = True Then
    spdatrep.Sections(2).Controls("repname").Caption = "Material Wise Report (Sorted)"
Else
    spdatrep.Sections(2).Controls("repname").Caption = "Material Wise Report (Selected)"
End If

spdatrep.Sections(2).Controls("repname").Caption = "From Date: " & CStr(DTPicker1.Value) & "      To Date: " & CStr(DTPicker2.Value)
If Option2.Value = True Then
    spdatrep.Sections(2).Controls("repname").Caption = spdatrep.Sections(2).Controls("repname").Caption + "     Material: " & Text1.Text
End If
