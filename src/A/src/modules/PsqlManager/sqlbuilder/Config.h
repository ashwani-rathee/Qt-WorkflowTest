...
struct Config
{
     ...
     * \param portname            -- obviously, portname
     * \param dbname              -- obviously, database name
     * \param username            -- obviously, db user name
     * \param password            -- obviously, db user password
     */
    static void setConnectionParams(const QString& driver, const QString& hostname, const QString& portname, const QString& dbname
